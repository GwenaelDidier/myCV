                    ...
                    <blockquote>
                        ...
                        <cite>
                            <Typography gutterBottom variant="h6" component="div" textAlign="center" width="100%">
                                Bonjour, je m'appelle Gwenael et j'ai 39 ans.<br />
                                Je travaille dans le développement logiciel orienté utilisateur.<br />
                            </Typography>
                        </cite>
                        <cite>
                            <Typography gutterBottom variant="h6" component="div" textAlign="center" width="100%">
            ...
            <div className="grid">
                ...
                <div className="grid-item" id="item-2-1">
                    <Card sx={{ width: '100%' }} className="card-bio">
                        ...
                        <CardActions sx={{ display: 'flex', justifyContent: 'center' }}>
                            <HtmlOutlinedIcon sx={{ fontSize: '1.8em', alignSelf: 'flex-start', marginRight: '1em' }} color="primary" />
                        ...
                        <CardActions sx={{ display: 'flex', justifyContent: 'center' }}>
                            <DnsOutlinedIcon sx={{ fontSize: '1.8em', alignSelf: 'flex-start', marginRight: '1em' }} color="primary" />
                            <Typography gutterBottom variant="h5" component="div" textAlign="center">
                        ...
                        <CardActions sx={{ display: 'flex', justifyContent: 'center' }}>
                            <StorageOutlinedIcon sx={{ fontSize: '1.8em', alignSelf: 'flex-start', marginRight: '1em' }} color="primary" />
                            <Typography gutterBottom variant="h5" component="div" textAlign="center">
                ...
                <div className="grid-item" id="item-2-3">
                    <Card sx={{ width: '100%' }} className="card-bio">
                        ...
                        <CardActions sx={{ display: 'flex', justifyContent: 'center' }}>
                            <AlternateEmailOutlinedIcon sx={{ fontSize: '1.8em', alignSelf: 'flex-start', marginRight: '1em' }} color="primary" />
                            <Typography gutterBottom variant="h5" component="div" textAlign="center" >
